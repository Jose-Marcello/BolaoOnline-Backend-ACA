...
var NgxMaskDirective = class _NgxMaskDirective {
  ...
  static ɵdir = ɵɵdefineDirective({
    ...
    inputs: {
      mask: [InputFlags.SignalBased, "mask"],
      specialCharacters: [InputFlags.SignalBased, "specialCharacters"],
      patterns: [InputFlags.SignalBased, "patterns"],
      prefix: [InputFlags.SignalBased, "prefix"],
      suffix: [InputFlags.SignalBased, "suffix"],
      thousandSeparator: [InputFlags.SignalBased, "thousandSeparator"],
      decimalMarker: [InputFlags.SignalBased, "decimalMarker"],
      dropSpecialCharacters: [InputFlags.SignalBased, "dropSpecialCharacters"],
      hiddenInput: [InputFlags.SignalBased, "hiddenInput"],
      showMaskTyped: [InputFlags.SignalBased, "showMaskTyped"],
      placeHolderCharacter: [InputFlags.SignalBased, "placeHolderCharacter"],
      shownMaskExpression: [InputFlags.SignalBased, "shownMaskExpression"],
      clearIfNotMatch: [InputFlags.SignalBased, "clearIfNotMatch"],
      validation: [InputFlags.SignalBased, "validation"],
      separatorLimit: [InputFlags.SignalBased, "separatorLimit"],
      allowNegativeNumbers: [InputFlags.SignalBased, "allowNegativeNumbers"],
      leadZeroDateTime: [InputFlags.SignalBased, "leadZeroDateTime"],
      leadZero: [InputFlags.SignalBased, "leadZero"],
      triggerOnMaskChange: [InputFlags.SignalBased, "triggerOnMaskChange"],
      apm: [InputFlags.SignalBased, "apm"],
      inputTransformFn: [InputFlags.SignalBased, "inputTransformFn"],
      outputTransformFn: [InputFlags.SignalBased, "outputTransformFn"],
      keepCharacterPositions: [InputFlags.SignalBased, "keepCharacterPositions"],
      instantPrefix: [InputFlags.SignalBased, "instantPrefix"]
    },
    outputs: {
