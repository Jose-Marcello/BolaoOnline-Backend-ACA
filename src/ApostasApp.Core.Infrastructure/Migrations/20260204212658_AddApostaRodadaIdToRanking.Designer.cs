...
namespace ApostasApp.Core.Infrastructure.Migrations
{
    ...
    [Migration("20260204212658_AddApostaRodadaIdToRanking")]
    partial class AddApostaRodadaIdToRanking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApostasApp.Core.Domain.Models.RankingRodadas.RankingRodada", b =>
                {
                    b.HasOne("ApostasApp.Core.Domain.Models.Apostas.ApostaRodada", "ApostaRodada")
                        .WithOne("RankingRodada")
                        .HasForeignKey("ApostasApp.Core.Domain.Models.RankingRodadas.RankingRodada", "ApostaRodadaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
