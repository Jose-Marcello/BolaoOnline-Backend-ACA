...
namespace ApostasApp.Core.Application.Services.Interfaces.Palpites
{
    ...
    public interface IPalpiteService : INotifiableService
    {
        /// <summary>
        ...
        // <<-- CORRIGIDO: Retorna ApiResponse<IEnumerable<PalpiteDto>> -->>
        ...
        // <<-- CORRIGIDO: Retorna ApiResponse<PalpiteDto> -->>
        ...
        // <<-- CORRIGIDO: Retorna ApiResponse<bool> -->>
